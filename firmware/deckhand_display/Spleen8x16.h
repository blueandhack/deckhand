// Spleen 16px - Adafruit_GFX font, printable ASCII 0x20-0x7E only.
// Generated from spleen-8x16.bdf by bdf2gfx.py - do not edit by hand.
...
const GFXglyph Spleen8x16Glyphs[] PROGMEM = {
  ...
  {   960,  8, 16,  8,   0, -12 },  // 0x5C 'backslash'
